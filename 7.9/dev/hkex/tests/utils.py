...
UserName.PRIMARY.register('hkex_un')
UserName.NON_PRIMARY.register('hkex_nonp_un')
OperatorID.PRIMARY.register('hkex_oid')
OperatorID.NON_PRIMARY.register('hkex_nonp_oid')
SubUserId.VALID_PRIMARY.register('hkex_suid')
